...
function ListPage() {
    ...
    return (<div>
        {
            modal && <>
                <div className="fixed z-10 inset-0 bg-[#000000b3] w-full h-full" onClick={() => {
                    setModal(false)
                }}>
                </div>
                <div className="fixed z-20 inset-0 bg-[#fff] w-[80%] h-[80%] m-auto text-[#000] p-4">
                    <h3 className="font-bold">新しいリストを追加</h3>
                    <div>
                        <span>商品名</span>
                        <input type="text" className="w-[70%] border mb-2 ml-2 mr-auto" />
                    </div>
                    <div>
                        <span>ジャンル</span>
                        <input type="text" className="w-[70%] border mb-2 ml-2 mr-auto" />
                    ...
                    <button className="bg-[#000] rounded w-full text-[#fff] font-bold" onClick={() => {
                        setModal(false)
                    }}>登録</button>
                </div>
            </>
        ...
        <div className=" bg-[#fff] text-black font-bold mx-4 rounded-lg py-2 text-center pl-2 mt-4" onClick={() => {
            setModal(true)
        }}>新しいリストを追加</div>
